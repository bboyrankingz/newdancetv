		...
		********************************************/
		var loadAllPrepared = function(container,alreadyinload) {
			...
			container.find('img, .defaultimg').each(function(i) {
				...
				if (ill!=img.attr('ng-src') && alreadyinload<3 && ill!=undefined && ill!='undefined') {
					...
					if ((ill === undefined || ill === 'undefined') && img.data('lazydone')!=1) {
						...
						if (img.attr('ng-src')!=undefined && img.attr('ng-src')!='undefined') 	{
							limg.src = img.attr('ng-src');
						} else
		...
		var swapSlide = function(container,opt) {
				...
				if (defimg.data('lazyload') !=undefined && defimg.data('lazyload') !="undefined" && defimg.data('lazydone') !=1 ) {
					...
					if (!isIE(8))
						...
						defimg.attr('ng-src',nextli.find('.defaultimg').data('lazyload'));
					}
		...
		var nextli = container.find('>ul:first-child >li:eq('+opt.next+')'),
			...
			nextsh.find('.defaultimg').each(function() {
				...
				if (nextsh.find('.kenburnimg').length==0)
					nextsh.append('<div class="kenburnimg" style="position:absolute;z-index:1;width:100%;height:100%;top:0px;left:0px;"><img src="'+defimg.attr('ng-src')+'" style="-webkit-touch-callout: none;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;position:absolute;width:'+imgobj.w+'%;height:'+imgobj.h+'%;"></div>');
				else {
